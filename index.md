...
The latest tools: load iLang into any model, check it and measure it.

iLang loader pip · npm

v1.1.0

Gives any model the official iLang: fetched from the canon, sha256-checked, cached and put in front of every request. Checked on DeepSeek, Qwen, Gemini, GPT and Claude.

[GitHub](https://github.com/ilang-ai/ilang) [PyPI](https://pypi.org/project/ilang-protocol/) [npm](https://www.npmjs.com/package/ilang-protocol)

iLang runtime canon

18.6k tokens

What an AI loads, generated by CI from the specification: one file with its sha256, every version pinned. The core is about 18,600 tokens and points to the full text for anything it leaves out; the media extension adds about 18,000.

[GitHub](https://github.com/ilang-ai/ilang-spec/tree/main/runtime) [Manifest](https://raw.githubusercontent.com/ilang-ai/ilang-spec/main/runtime/manifest.json) [Full text](https://ilang.ai/runtime/full)

ilang-conformance benchmark

320 cases

A deterministic test set for grammar, execution and judgment. Code scores any model behind an API; no model grades another. 45 runs are published.

[GitHub](https://github.com/ilang-ai/ilang-conformance) [Results](https://research.ilang.ai/datasets/ilang-conformance/)

Playground browser

validator + IML

Validate iLang with the canon grammar validator, convert chains to IML and back, and count cl100k tokens. Everything runs in your browser; your input never leaves it.

[Open](https://ilang.ai/playground/)

Agent Ready GEO agent skill

100/100

Takes a website to 100/100 on isitagentready.com: llms.txt, Markdown for agents, WebMCP, an MCP server card and more. Its instructions are written in iLang.

[GitHub](https://github.com/ilang-ai/agent-ready-geo)
