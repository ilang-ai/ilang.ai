...
- **Dans une conversation :** copiez le [runtime iLang le plus récent](https://runtime.ilang.app/ilang-latest.md), ou cliquez sur « Copy latest iLang » sur [ilang.ai](https://ilang.ai), et collez-le dans ChatGPT, Claude, Gemini, DeepSeek, Qwen ou tout autre assistant.
